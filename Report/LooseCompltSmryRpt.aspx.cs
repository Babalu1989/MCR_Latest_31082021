...
public partial class Report_LooseCompltSmryRpt : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable _dtDetails = objBL.getCompleteLooseRpt(Session["COMPANY"].ToString(), _gFrom, _gTo, _gddlDivision, _gddlVendorName, _sOrdType, _sActType);//Added Some Parameter related to attached PCN 2109202005

            if (_dtDetails.Rows.Count > 0)
            {
                if (_dtDetails.Rows.Count < 151)
                {
