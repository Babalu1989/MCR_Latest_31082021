<%@ Page Language="C#" MasterPageFile="SiteMaster.master" AutoEventWireup="true"
    ClientIDMode="Static" CodeFile="MeterReconciliation.aspx.cs" Inherits="_Default"
    Title="Meter Reconciliation Report" %>
            ...
            <table style="text-align: center" width="90%">
                <tr>
                    <td style="height: 15px">
                        <h2>
                            Meter Reconciliation Report</h2>
                    </td>
                </tr>
                <tr>
                    <td style="height: 15px">
                            ...
                            <tr>
                                <td colspan="4" align="center">
                                    ...
                                    <asp:Button ID="btnExit" runat="server" Text="Exit" CssClass="submit" Height="30px"
                                        Width="150px" OnClick="btnExcel_Click1" />
                                          </ContentTemplate>
                                      <Triggers>
...
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    ...
                                    <asp:TemplateField HeaderText="Meters Issued To Vendor">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkbtnCASESCOUNT" CommandName="CASESCOUNT" runat="server" Text='<%#Eval("Meters_Issued_To_Vendor")%>'
                                                ForeColor="Black" CommandArgument='<%#Eval("DIVISION")+ "," + Eval("VENDOR_CODE")%>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Pending for Alottment to Installer">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkbtnMETERSNOTASSIGN" CommandName="METERSNOTASSIGN" runat="server"
                                                Text='<%#Eval("Pending_Alottment_TO_Installer")%>' ForeColor="Black" CommandArgument='<%#Eval("DIVISION")+ "," + Eval("VENDOR_CODE")%>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Meters Installed">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkbtnMETERSCONSUMED" CommandName="METERSCONSUMED" runat="server"
                                                Text='<%#Eval("Meters_Installed")%>' ForeColor="Black" CommandArgument='<%#Eval("DIVISION")+ "," + Eval("VENDOR_CODE")%>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Meters Pending at Installer Side">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkbtnMETERPENDING" CommandName="METERPENDING" runat="server"
                                                Text='<%#Eval("Mtr_Pndng_Instlr_Side")%>' ForeColor="Black" CommandArgument='<%#Eval("DIVISION")+ "," + Eval("VENDOR_CODE")%>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Meters Cancelled">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkbtnMETERSCANCEL" CommandName="METERSCANCEL" runat="server"
                                                Text='<%#Eval("Mtr_Cancelled")%>' ForeColor="Black" CommandArgument='<%#Eval("DIVISION")+ "," + Eval("VENDOR_CODE")%>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" />
                                    </asp:TemplateField>
                                </Columns>
                                ...
                                <asp:GridView ID="gvDetails" AllowSorting="True" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="COMPANY" HeaderText="Company" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="6.5%" ItemStyle-Width="6.5%" SortExpression="COMPANY" >
<HeaderStyle Width="6.5%"></HeaderStyle>

<ItemStyle HorizontalAlign="Left" Width="6.5%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DIV_NAME" HeaderText="Division" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="6.5%" ItemStyle-Width="6.5%" SortExpression="DIV_NAME" >
<HeaderStyle Width="6.5%"></HeaderStyle>

<ItemStyle HorizontalAlign="Left" Width="6.5%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="ORDERID" HeaderText="Order" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="6.5%" ItemStyle-Width="6.5%" SortExpression="ORDERID" >
<HeaderStyle Width="6.5%"></HeaderStyle>

<ItemStyle HorizontalAlign="Left" Width="6.5%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="CA_NO" HeaderText="CA No" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="6.5%" ItemStyle-Width="6.5%" SortExpression="CA_NO" >
<HeaderStyle Width="6.5%"></HeaderStyle>

<ItemStyle HorizontalAlign="Left" Width="6.5%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="METER_NO" HeaderText="Meter No" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-Width="6.5%" ItemStyle-Width="6.5%" SortExpression="METER_NO" >
<HeaderStyle Width="6.5%"></HeaderStyle>
