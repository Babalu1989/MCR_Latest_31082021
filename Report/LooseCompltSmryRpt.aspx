<%@ Page Title="" Language="C#" MasterPageFile="SiteMaster.master" AutoEventWireup="true" CodeFile="LooseCompltSmryRpt.aspx.cs" 
Inherits="Report_LooseCompltSmryRpt" %>
            ...
            <table style="text-align: center" width="90%">
                <tr>
                    <td style="height: 15px">
                        <h2>
                            Loose Completed Meter Installation Report</h2>
                    </td>
                </tr>
                <tr>
                    <td style="height: 15px">
                          ...
                          <div id="GridView1_div" runat="server" style="width: 100%;">
                            ...
                            <asp:GridView ID="gvMainData" AllowSorting="true" CssClass="gvwWhite" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="BUSBAR_TO_METER_CABLE_SIZE" HeaderText="BUSBAR TO METER CABLE SIZE" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="BUSBAR_TO_METER_CABLE_LENGTH" HeaderText="BUSBAR TO METER CABLE LENGTH" ItemStyle-HorizontalAlign="Left" />
