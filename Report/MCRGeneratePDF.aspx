<%@ Page Title="" Language="C#" MasterPageFile="SiteMaster.master" AutoEventWireup="true"
    CodeFile="MCRGeneratePDF.aspx.cs" Inherits="Report_MCRGeneratePDF" %>
            ...
            <table style="text-align: center" width="90%">
                ...
                <tr>
                    <td style="height: 30px" align="right">
                        <asp:ImageButton ID="btnpdf" runat="server" ImageUrl="~/Image/pdf_icon.gif" Height="30px"
                            Width="80px" Visible="false" OnClick="btnpdf_Click" />
                    </td>
                    <td style="height: 30px" align="right">
                            ...
                            <div style="overflow: scroll; width: 99.9%; max-height: 370px">
                                <asp:GridView ID="gvMainData" AllowSorting="True" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lkSelectAll" runat="server" ForeColor="White" OnClick="lkSelectAll_Click">Select All</asp:LinkButton>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="CA No.">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCA" runat="server" Text='<%#Eval("CA_NO")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <%-- <asp:BoundField DataField="ORDERID" HeaderText="Order No" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:BoundField DataField="ORDER_TYPE" HeaderText="Order Type" ItemStyle-HorizontalAlign="Left"
                                            SortExpression="ORDER_TYPE" HeaderStyle-Font-Underline="true" HeaderStyle-Width="15%"
                                            ItemStyle-Width="15%">
                                        ...
                                        <asp:BoundField DataField="PM_ACT" HeaderText="PM Activity" ItemStyle-HorizontalAlign="Left"
                                            SortExpression="PM_ACT" HeaderStyle-Font-Underline="true" HeaderStyle-Width="15%"
                                            ItemStyle-Width="15%">
                                            <HeaderStyle Font-Underline="True" Width="15%"></HeaderStyle>
                                            <ItemStyle HorizontalAlign="Left" Width="15%"></ItemStyle>
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderText="Type">
                                            <ItemTemplate>
                                                <asp:Label ID="lblType" runat="server" Text='<%#Eval("ORD_TYPE")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <%-- <asp:TemplateField HeaderText="Generate">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImageMCRPDF" CommandArgument='<%#Eval("ORD_TYPE")%>' CommandName='<%#Eval("ORDERID")+"," + Eval("CA_NO")%>'
                                                    ImageUrl="~/Image/pdf_icon.gif" Width="25px" Height="25px" OnCommand="ImageMCRPDF_Command"
                                                    runat="server" ToolTip="Generate PDF" />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>--%>
                                        <asp:BoundField DataField="OLD_MR_KWH" HeaderText="OLD_MR_KWH" ItemStyle-HorizontalAlign="Left"
                                            SortExpression="OLD_MR_KWH" HeaderStyle-Font-Underline="true" Visible="false">
