<%@ Page Language="C#" MasterPageFile="SiteMaster.master" AutoEventWireup="true"
    ClientIDMode="Static" CodeFile="MMG_ISU.aspx.cs" Inherits="_Default" Title="Meter Reconciliation Report" %>
            ...
            <table style="text-align: center" width="90%">
                <tr>
                    <td style="height: 15px">
                        <h2>
                            Monitoring Report For MMG Coordinator Through TAB</h2>
                    </td>
                </tr>
                <tr>
                    <td style="height: 15px">
...
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    ...
                                    <asp:TemplateField HeaderText="Cases Given to Vendor">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkbtnCASESCOUNT" CommandName="CASESCOUNT" runat="server" Text='<%#Eval("Cases_Given_Vendor")%>'
                                                ForeColor="Black" CommandArgument='<%#Eval("DIVISION")%>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Cases Executed">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkbtnMETERSCONSUMED" CommandName="METERSCONSUMED" runat="server"
                                                Text='<%#Eval("Cases_Executed")%>' ForeColor="Black" CommandArgument='<%#Eval("DIVISION")%>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Cases Pending">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkbtnMETERPENDING" CommandName="METERPENDING" runat="server"
                                                Text='<%#Eval("Cases_Pending")%>' ForeColor="Black" CommandArgument='<%#Eval("DIVISION")%>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Cases Required to Cancel">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkbtnMETERSCANCEL" CommandName="METERSCANCEL" runat="server"
                                                Text='<%#Eval("Cases_Required_Cancel")%>' ForeColor="Black" CommandArgument='<%#Eval("DIVISION")%>'></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" />
                                    </asp:TemplateField>
                                </Columns>
