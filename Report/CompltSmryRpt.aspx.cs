...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable _dtDetails = objBL.getCompleteRpt(Session["COMPANY"].ToString(), _gFrom, _gTo, _gddlDivision, _gddlVendorName, _sOrdType, _sActType);//Added Some Parameter related to attached PCN 2109202005
