<%@ Page Language="C#" MasterPageFile="SiteMaster.master" AutoEventWireup="true"
    ClientIDMode="Static" CodeFile="MCR_Upload.aspx.cs" Inherits="_Default" Title="Quality Check Report" %>
                                ...
                                <asp:GridView ID="gvMainData" AllowSorting="True" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="View">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgComplaintID" CommandArgument='<%#Eval("ORDERID")%>' CommandName='<%#Eval("ORDER_TYPE")+"-"+Eval("PM_ACT")%>'
                    ...
                    <table style="border: 1px solid black; font-weight: bold; width: 90%">
                        <tr id="tr1" runat="server">
                            <td style="vertical-align: middle">
                                <%--Meter Photograph--%>
                                <asp:Label ID="lblMtrPhotograph" runat="server" Visible="false"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr id="tr2" runat="server">
                            <td>
                                ...
                                <asp:Label ID="lblcompmtrPhotograph" runat="server" Visible="false"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr id="tr5" runat="server">
                            <td>
                                <%-- MCR--%>
                                <asp:Label ID="lblMCR" runat="server" Visible="false"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr id="tr6" runat="server">
                            <td>
                                <%-- Meter Test Report--%>
                                <asp:Label ID="lblMtrTest" runat="server" Visible="false"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr id="tr14" runat="server">
                            <td>
                                Cancel Consumer Signature
                            </td>
                            <td>
                                <%--<asp:Image ID="imgCancel" runat="server" BackColor="Black" Width="100%" />--%>
                                <asp:ImageButton ID="ImageCancelSignature" runat="server" ImageUrl="~/Image/up.gif"
                                    OnClick="ImageCancelSign_Click" />
                            </td>
                        </tr>
                        <tr id="tr15" runat="server">
                            ...
                            <td>
                                <%--<asp:Image ID="imgCancel" runat="server" BackColor="Black" Width="100%" />--%>
                                <asp:ImageButton ID="ImageCancelPDF" runat="server" ImageUrl="~/Image/up.gif" OnClick="ImageCancelPDF_Click" />
                            </td>
                        </tr>
