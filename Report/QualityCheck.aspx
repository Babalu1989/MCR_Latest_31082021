<%@ Page Language="C#" MasterPageFile="SiteMaster.master" AutoEventWireup="true"
    ClientIDMode="Static" CodeFile="QualityCheck.aspx.cs" Inherits="_Default" Title="Quality Check Report" %>
...
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    ...
                                    <asp:BoundField DataField="CA_NO" HeaderText="CA No" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="CA_NO" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="METER_NO" HeaderText="Meter No" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="METER_NO" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="INSTALLATION" HeaderText="Meter Installed Location" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="INSTALLATION" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ELCB_INSTALLED" HeaderText="ELCB Installed" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="ELCB_INSTALLED" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="METERDOWNLOAD" HeaderText="Meter Downloaded" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="METERDOWNLOAD" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="FLOWMADE" HeaderText="Flower Made" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="FLOWMADE" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="EARTHING" HeaderText="Earthing at Meter End" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="EARTHING" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="HEIGHTOFMETER" HeaderText="Height Of Meter" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="HEIGHTOFMETER" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ANYJOINTS" HeaderText="Any Joints in Service Cable" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="ANYJOINTS" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="DBLOCKED" HeaderText="DB locked" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="DBLOCKED" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="EARTHINGPOLE" HeaderText="Earthing at Pole End" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="EARTHINGPOLE" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ADDITIONALACCESSORIES" HeaderText="Gland Used" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="OVERHEADCABLE" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="OVERHEADCABLE" HeaderText="Fixtures Installed at Meter End"
                                        ItemStyle-HorizontalAlign="Left" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="OVERHEADCABLEPOLE" HeaderText="Fixtures installed at Pole End"
                                        ItemStyle-HorizontalAlign="Left" >
