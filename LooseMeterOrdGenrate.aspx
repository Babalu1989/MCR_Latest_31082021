<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="LooseMeterOrdGenrate.aspx.cs" Inherits="LooseMeterOrdGenrate" %>
            ...
            <table width="95%">
                ...
                <tr>
                    <td style="height: 15px; text-align:center">
                      <h2>
                                <i>Loose Meter Order Generate</i></h2>
                      </td>
                </tr>
                            ...
                            <table width="90%" style="border: 1px solid black;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        Meter Series List Seperated with (M1,M2)
                                    </td>
                                    <td style = "text-align:left;"  colspan="3">
                                        <asp:TextBox ID="txtMeterNoFromTo" CssClass="textarea"  runat="server"
                                            Width="660px"></asp:TextBox>
                                    </td>                                    
                                </tr>
                                <tr>
                                 <td>                                        
                                        CA No List Seperated with (C1,C2)
                                    </td>
                                    <td colspan="3">
                                         <asp:TextBox ID="txtCANoFrmTo" CssClass="textarea"  runat="server"
                                            Width="660px"></asp:TextBox>
                                    </td>
                                </tr>
...
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                     ...
                                     <asp:BoundField DataField="VEN_CODE" HeaderText="Vendor" ItemStyle-HorizontalAlign="Left"
...
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    ...
                                    <asp:BoundField DataField="Address" HeaderText="Address" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="Address" HeaderStyle-Font-Underline="true" ItemStyle-Width="10%" >
<HeaderStyle Font-Underline="True"></HeaderStyle>
...
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    ...
                                    <asp:BoundField DataField="ACTIVITY_DATE" HeaderText="Act Date" ItemStyle-HorizontalAlign="Left"
                                        SortExpression="ACTIVITY_DATE" HeaderStyle-Font-Underline="true" >
<HeaderStyle Font-Underline="True"></HeaderStyle>
...
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                     ...
                     <ItemTemplate>                                                  
                           <asp:ImageButton ID="imgAction" CommandArgument='<%# Eval("NEW_METER") %>' CommandName='<%# Eval("NEW_METER") %>' 
                            ...
                            <div style="float: left; color: Black; padding: 5px 5px 0 0">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" align="right">
                                        <asp:Button ID="btnSubmit" runat="server" Text="Order Generate" CssClass="submit"
                                            Height="30px" Width="200px" OnClick="btnSubmit_Click" />
                                        <asp:Label ID="lblSapOrderMsg" Visible="false" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
